...
//   }
  ...
  return (
    ...
    <img src="/skyline.jpg" alt="background" className="object-cover object-center h-screen w-full rounded-full" />
    <div className="absolute inset-0 opacity-75 bg-black flex flex-col justify-center items-center shadow-lg">
      <h1 className="text-6xl font-bold text-orange-600 mb-4">Sign Up</h1>
